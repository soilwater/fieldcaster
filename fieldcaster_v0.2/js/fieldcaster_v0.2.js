        ...
        if (climate[k].month === (management.plantingDate.getMonth()+1) && climate[k].day === management.plantingDate.getDate() && (k+250) < climate.length){
            ...
            while (inGrowingSeason){
                ...
                if(thermalUnitsCumulative[n] >= plant.maturityThermalUnits || k+1 >= climate.length){
                    ...
                    outputs.ETcropCumulative.push({x:xVariable, y:ETcropCumulative, mode:'line', name:"Y"+currentYear, line: {color: "rgb(220, 220, 220)"}});
                    outputs.ETrefCumulative.push({x:xVariable, y:ETrefCumulative, mode:'line', name:"Y"+currentYear, line: {color: "rgb(220, 220, 220)"}});
